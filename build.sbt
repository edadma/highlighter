...
ThisBuild / scmInfo := Some(
  ScmInfo(
    url("https://github.com/edadma/highlighter"),
    "scm:git@github.com:edadma/highlighter.git",
  ),
)
...
//    ),
    libraryDependencies ++= Seq(
      ...
      "io.github.edadma" %%% "oniguruma"  % "0.0.4",
    ),
...
lazy val root = project
  .in(file("."))
  .aggregate(highlighter.js, highlighter.jvm, highlighter.native)
  .settings(
    name                := "highlighter",
    publish / skip      := true,
